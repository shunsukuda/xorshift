...
func (x *Xoshiro256p) SetState(state []byte) {
...
func (x Xoshiro256p) String() string {
	return fmt.Sprintf("%064x", x.State())
}

func (x Xoshiro256p) GoString() string {
	return "xrand.Xoshiro256p{state:\"" + x.String() + "\"}"
}
