...
// https://prng.di.unimi.it/xoshiro1024star.c

type Xoshiro1024s struct {
	s [16]uint64
	p int
}

func (x *Xoshiro1024s) Seed(seed int64) {
...
func (x *Xoshiro1024s) Uint64() uint64 {
	q := x.p
	x.p = (x.p + 1) & 15
	s0 := x.s[x.p]
	s15 := x.s[q]
...
func (x *Xoshiro1024s) Int64() int64 {
	return unsafeUint64ToInt64(x.Uint64())
}

func (x *Xoshiro1024s) Int63() int64 {
	return int64(x.Uint64() & (1<<63 - 1))
}

// Call Uint64() * 2^512
func (x *Xoshiro1024s) Jump() {
	var (
		jump = [...]uint64{
