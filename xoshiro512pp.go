...
type Xoshiro512pp struct {
	s [8]uint64
}

func NewXoshiro512pp(seed int64) *Xoshiro512pp {
	x := Xoshiro512pp{}
	x.Seed(seed)
	return &x
}
...
func (x *Xoshiro512pp) Uint64() uint64 {
	result := bits.RotateLeft64(x.s[0]+x.s[2], 17) + x.s[2]
	t := x.s[1] << 11
...
func (x *Xoshiro512pp) Int64() int64 {
	return unsafeUint64ToInt64(x.Uint64())
}

func (x *Xoshiro512pp) Int63() int64 {
	return int64(x.Uint64() & (1<<63 - 1))
}

func (x *Xoshiro512pp) Float64() float64 {
	return math.Float64frombits(0x3ff<<52|x.Uint64()>>12) - 1.0
}

// Call Uint64() * 2^256
func (x *Xoshiro512pp) Jump() {
	var (
		jump = [...]uint64{
