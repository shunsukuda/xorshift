...
// https://prng.di.unimi.it/xoshiro1024plusplus.c

type Xoshiro1024pp struct {
	s [16]uint64
	p int
}

func (x *Xoshiro1024pp) Seed(seed int64) {
...
func (x *Xoshiro1024pp) Uint64() uint64 {
	q := x.p
	x.p = (x.p + 1) & 15
	s0 := x.s[x.p]
	s15 := x.s[q]
...
func (x *Xoshiro1024pp) Int64() int64 {
	return unsafeUint64ToInt64(x.Uint64())
}

func (x *Xoshiro1024pp) Int63() int64 {
	return int64(x.Uint64() & (1<<63 - 1))
}

// Call Uint64() * 2^512
func (x *Xoshiro1024pp) Jump() {
	var (
		jump = [...]uint64{
