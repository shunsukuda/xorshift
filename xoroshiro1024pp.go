...
func (x *Xoroshiro1024pp) Uint64() uint64 {
	q := x.p
	x.p = (x.p + 1) & 15
	s0 := x.s[x.p]
	s15 := x.s[q]
...
func (x *Xoroshiro1024pp) Int64() int64 {
	return unsafeUint64ToInt64(x.Uint64())
}

func (x *Xoroshiro1024pp) Int63() int64 {
	return int64(x.Uint64() & (1<<63 - 1))
}

func (x *Xoroshiro1024pp) Float64() float64 {
	return math.Float64frombits(0x3ff<<52|x.Uint64()>>12) - 1.0
}

// Call Uint64() * 2^512
func (x *Xoroshiro1024pp) Jump() {
	var (
		jump = [...]uint64{
...
// Call Uint64() * 2^768
func (x *Xoroshiro1024pp) LongJump() {
	var (
		jump = [...]uint64{
