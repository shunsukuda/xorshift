...
func (x Xoshiro256pp) State() []byte {
	s := make([]byte, 32)
...
func (x *Xoshiro256pp) SetState(state []byte) {
...
func (x Xoshiro256pp) String() string {
	return fmt.Sprintf("%064x", x.State())
}

func (x Xoshiro256pp) GoString() string {
	return "xrand.Xoshiro256pp{state:\"" + x.String() + "\"}"
}
